...
const themeTags: InsertTag[] = [
  ...
  { slug: "reserve-quality-transparency", nameEn: "Reserve quality & transparency", nameZh: "储备质量与透明度", facet: "theme", definition: "储备资产构成、充足性、审计与披露透明度问题。", region: null, category: B, status: "active" },
  ...
  // C 监管与政策
  { slug: "regulatory-frameworks", nameEn: "Regulatory frameworks", nameZh: "监管框架", facet: "theme", definition: "针对稳定币的立法与监管框架,如 MiCA、美国 GENIUS Act 等。", region: null, category: C, status: "active" },
  { slug: "licensing-supervision", nameEn: "Licensing & supervision", nameZh: "牌照与监管", facet: "theme", definition: "发行方的牌照要求、准入门槛与持续监管。", region: null, category: C, status: "active" },
  ...
  { slug: "disclosure-accounting", nameEn: "Disclosure & accounting", nameZh: "披露与会计", facet: "theme", definition: "储备披露要求、会计处理与审计准则。", region: null, category: C, status: "active" },
  ...
  { slug: "dollarization-substitution", nameEn: "Dollarization & currency substitution", nameZh: "美元化与货币替代", facet: "theme", definition: "美元稳定币在他国引发的事实美元化与本币替代。", region: null, category: D, status: "active" },
  ...
  { slug: "capital-flows-sovereignty", nameEn: "Capital flows & monetary sovereignty", nameZh: "资本流动与货币主权", facet: "theme", definition: "稳定币对跨境资本流动管理与国家货币主权的冲击。", region: null, category: D, status: "active" },
  // E 市场与应用
  ...
  { slug: "trading-market-structure", nameEn: "Trading & market structure", nameZh: "交易与市场结构", facet: "theme", definition: "稳定币在交易、做市与加密市场微观结构中的角色。", region: null, category: E, status: "active" },
